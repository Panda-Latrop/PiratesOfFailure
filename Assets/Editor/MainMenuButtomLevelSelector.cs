...
[CustomEditor(typeof(MainMenuButtomLevelSelector))]
[CanEditMultipleObjects]
public class MainMenuButtomLevelSelectorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        DoLayoutListWithFoldout(this.list1);
    ...
    {
        var property = this.serializedObject.FindProperty("Segments");
        this.list1 = CreateAutoLayout(property);
    }
    public ReorderableList CreateAutoLayout(SerializedProperty property, float columnSpacing = 10f)
    {
        return CreateAutoLayout(property, true, true, true, true, null, null, columnSpacing);
    }

    public ReorderableList CreateAutoLayout(SerializedProperty property, string[] headers, float?[] columnWidth = null, float columnSpacing = 10f)
    {
        return CreateAutoLayout(property, true, true, true, true, headers, columnWidth, columnSpacing);
    }

    public ReorderableList CreateAutoLayout(SerializedProperty property, bool draggable, bool displayHeader, bool displayAddButton, bool displayRemoveButton, float columnSpacing = 10f)
    {
    ...
    public bool DoLayoutListWithFoldout(ReorderableList list, string label = null)
    {
